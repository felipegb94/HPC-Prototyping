...
int main()
{
    ...
    std::string dataArmaPath = "/home/felipe/data/wonhwa/data.arma";
    std::string permutationMatrix1ArmaPath = "/home/felipe/data/wonhwa/permutationMatrix1.arma";
    std::string permutationMatrix2ArmaPath = "/home/felipe/data/wonhwa/permutationMatrix2.arma";
